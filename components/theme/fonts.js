...
export const FONT_ASSETS = {
  [FONT_FAMILIES.satoshiRegular]: require('../../assets/fonts/satoshi/Satoshi-Regular.otf'),
  'Satoshi-Italic': require('../../assets/fonts/satoshi/Satoshi-Italic.otf'),
  [FONT_FAMILIES.satoshiMedium]: require('../../assets/fonts/satoshi/Satoshi-Medium.otf'),
